...
urlpatterns = [
    ...
    path('api/book/book_copies/<int:pk>/', views.BookCopies.as_view(), name='bookcopies'),
    ...
    path('api/issue/book/', views.CreateBookIssue.as_view(), name='issue-book'),
    path('api/issue_detail/<int:pk>/', views.IssueDetail.as_view(), name='issue-detail'),
    path('api/book_issues/', views.IssueList.as_view(), name='issue-list'),
    path('api/book_issues/expanded', views.IssueListExpanded.as_view(), name='issue-list-expanded'),
]